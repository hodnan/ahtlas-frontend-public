<template>
  <!-- Tela de erro quando não existir rota -->
  <div class="h-screen bg-blue-grey-darken-4">
    <div class="moon"></div>
    ...
    <div class="error_x">
      ...
      <div class="error__subtitle">Opa! Deu ruim...</div>
      <div class="error__description">Parece que você tentou acessar uma rota inexistente.</div>
      <div class="mt-5">
        <v-btn class="error__button error__button--active mt-0" to="/">Ir para a Home</v-btn>
        <v-btn class="error__button" color="blue-grey-lighten-3" @click="goToPrev()"
          >Voltar para a página anterior</v-btn
        >
      </div>
    </div>
...
export default {
  ...
  computed: {
    cordCanvas() {
      return document.getElementById('cord')
    },
    ctx() {
      return this.cordCanvas.getContext('2d')
    }
  },
  methods: {
    goToPrev() {
    ...
    animate() {
      ...
      this.ctx.bezierCurveTo(250, this.y1, 345, this.y2, 400, this.y3)
